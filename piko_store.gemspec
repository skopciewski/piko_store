...
begin
  require "./lib/piko_store/version"
rescue LoadError
  module PikoStore; VERSION = "0"; end
end

Gem::Specification.new do |spec|
  spec.name          = "piko_store"
  spec.version       = PikoStore::VERSION
  ...
  spec.homepage      = "https://github.com/skopciewski/piko_store"
  ...
  spec.add_runtime_dependency "bson", "~>4.2"
